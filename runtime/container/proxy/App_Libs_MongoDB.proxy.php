...
class MongoDB_4c71339b27d921a59419655c82226d5f extends MongoDB
{
    ...
    public function insert($table, $doc = [])
    {
        ...
        return self::__proxyCall(MongoDB::class, __FUNCTION__, self::getParamsMap(MongoDB::class, __FUNCTION__, func_get_args()), function ($table, $doc = []) use($__function__, $__method__) {
            try {
                $bulk = new BulkWrite();
                $bulk->insert($doc);
    ...
    public function update($table, $where = [], $doc = [])
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(MongoDB::class, __FUNCTION__, self::getParamsMap(MongoDB::class, __FUNCTION__, func_get_args()), function ($table, $where = [], $doc = []) use($__function__, $__method__) {
            try {
                $bulk = new BulkWrite();
    ...
    public function delete($table, $where = [])
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(MongoDB::class, __FUNCTION__, self::getParamsMap(MongoDB::class, __FUNCTION__, func_get_args()), function ($table, $where = []) use($__function__, $__method__) {
            try {
                $bulk = new BulkWrite();
                $bulk->delete($where);
                $result = $this->manager()->executeBulkWrite($this->param['database'] . "." . $table, $bulk);
    ...
    public function find($table, $where = [], $start = 0, $size = 10, $sort = [])
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(MongoDB::class, __FUNCTION__, self::getParamsMap(MongoDB::class, __FUNCTION__, func_get_args()), function ($table, $where = [], $start = 0, $size = 10, $sort = []) use($__function__, $__method__) {
            try {
                $options = [];
                //排序
                $options['sort'] = !empty($sort) ? $sort : ['id' => -1];
                //分页
                $options['skip'] = !empty($start) ? (int) $start : 0;
                //起始
                $options['limit'] = !empty($size) ? (int) $size : 10;
                //返回条数
